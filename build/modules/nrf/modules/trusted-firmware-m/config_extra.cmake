...
set(NRFXLIB_DIR          /opt/nordic/ncs/v2.8.0/nrfxlib            CACHE STRING "nrfxlib folder")
set(NRF_SECURITY_ROOT    /opt/nordic/ncs/v2.8.0/nrf/subsys/nrf_security          CACHE STRING "nrf_security root folder")
set(OBERON_PSA_CORE_PATH /opt/nordic/ncs/v2.8.0/modules/crypto/oberon-psa-crypto  CACHE STRING "oberon-psa-core folder")
set(ARM_MBEDTLS_PATH     /opt/nordic/ncs/v2.8.0/modules/crypto/mbedtls            CACHE STRING "Mbed TLS folder")
set(NRF_DIR              /opt/nordic/ncs/v2.8.0/nrf                              CACHE STRING "NRF folder")
...
set(PSA_CRYPTO_CONFIG_INTERFACE_PATH    /Users/ngensadmin/Documents/Actinius_icarus_nrf9160/echo_bot_2/build/generated/interface_nrf_security_psa CACHE STRING "Path used for generated PSA crypto configuratiosn for the interface")
set(PSA_CRYPTO_CONFIG_LIBRARY_PATH      /Users/ngensadmin/Documents/Actinius_icarus_nrf9160/echo_bot_2/build/generated/library_nrf_security_psa CACHE STRING "Path used for generated PSA crypto for library builds")
