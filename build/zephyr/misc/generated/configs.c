...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ACTINIUS_BOARD_CONTROL_INIT_PRIORITY, 99);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ACTINIUS_CHARGER_ENABLE_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ACTINIUS_SIM_SELECT_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_SIZE, 168);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_BASE_ADDRESS, 0x20016000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_SECURE_UART_SHARE_INSTANCE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_ACTINIUS_ICARUS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_ACTINIUS_ICARUS_NRF9160_NS, 1);
